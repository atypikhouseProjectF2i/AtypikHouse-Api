...
class App_KernelTestDebugContainer extends Container
{
    ...
    protected function getApiPlatform_FilterLocatorService()
    {
        return $this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'annotated_app_entity_accommodation_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_accommodation_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityAccommodationApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_booking_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_booking_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityBookingApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService', true],
        ], [
            'annotated_app_entity_accommodation_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_booking_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
        ]);
    }
