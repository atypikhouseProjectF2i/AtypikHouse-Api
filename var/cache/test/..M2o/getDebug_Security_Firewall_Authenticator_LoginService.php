...
class getDebug_Security_Firewall_Authenticator_LoginService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['debug.security.firewall.authenticator.login'] = new \Symfony\Component\Security\Http\Authenticator\Debug\TraceableAuthenticatorManagerListener(($container->privates['debug.security.firewall.authenticator.login.inner'] ?? $container->load('getDebug_Security_Firewall_Authenticator_Login_InnerService')));
    }
}
